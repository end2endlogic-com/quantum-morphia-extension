package com.end2endlogic.quantum.extension.deployment.devui;
...
public class MorphiaDevUIProcessor {
    ...
    void createVersion(
        ...
        card.addPage(
            Page.externalPageBuilder("Home Page")
                .icon("font-awesome-solid:code")
                .url(
                    format(
                        "https://morphia.dev/morphia/%s/quicktour.html",
        ...
        card.addPage(
            Page.externalPageBuilder("Critter Home Page")
                .icon("font-awesome-solid:code")
                .url(format("https://morphia.dev/critter/4.4/index.html"))
                .doNotEmbed()
        );
        card.addPage(
            Page.externalPageBuilder("MongoDB Tutorial")
                .icon("font-awesome-solid:code")
